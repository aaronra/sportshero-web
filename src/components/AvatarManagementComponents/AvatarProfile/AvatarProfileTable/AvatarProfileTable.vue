    ...
    <section id="AvatarProfileTable">
        <b-table
            ...
            <template slot-scope="props">
                <b-table-column field="Users" label="Users" centered>
                    {{props.row.user}}
                </b-table-column>
                <b-table-column field="Email" label="Email" centered>
                    {{props.row.email}}
                </b-table-column>
                <b-table-column field="Date Granted" label="Date Granted" centered>
                    {{props.row.dateGranted}}
                </b-table-column>
                <b-table-column field="Winnings" label="Winnings" centered>
                    {{props.row.winnings}}
                </b-table-column>
            </template>
            <template slot="empty">
...
<script lang="ts" src="./AvatarProfileTable.ts"></script>
